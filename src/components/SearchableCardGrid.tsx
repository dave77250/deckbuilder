        ...
        <FlexBox direction={FlexBoxDirection.Column} style={{width: '100%'}}>
            ...
            ? <BasicGrid columns={nbCols} rows={4}>
                {displayedCards.map(card => {
                    ...
                    return (
                        <FlexBox key={card.id} direction={FlexBoxDirection.Column} style={{ padding: '5px', width: '100%', borderColor: cardColor, borderStyle: 'solid', borderWidth: 'thick', borderRadius: '5%' }}>
                            <CardView card={card}/>
